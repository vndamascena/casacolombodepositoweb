...
@Component({
    selector: 'app-editar-titulofuncionario',
    imports: [
        CommonModule, FormsModule, RouterModule,
        ReactiveFormsModule, NgxPaginationModule, NgxSpinnerModule,
        NgxImageZoomModule
    ],
    templateUrl: './editar-titulofuncionario.component.html',
    styleUrl: './editar-titulofuncionario.component.css'
})
export class EditarTitulofuncionarioComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.httpClient.get(`${environment.entregatitulo}/tituloreceberfuncionario/${productId}`)
    .subscribe({
      next: (data: any) => {
        this.titulo = data;
  ...
  onSubmit(): void {
    ...
    if (this.matricula && this.senha) {
      ...
      this.httpClient.put(`${environment.entregatitulo}/tituloreceberfuncionario`, formDataWithId, options)
        .subscribe({
          next: (data: any) => {
